...
customer6 = Customer.new({ 'name' => 'Hughie Gallagher', 'funds' => 20})
...
film1 = Film.new({'title' => 'Glen or Glenda', 'price' => 7})
film2 = Film.new({'title' => 'Robot Monster', 'price' => 7})
film3 = Film.new({'title' => 'Bride of the Monster', 'price' => 7})
...
ticket2 = Ticket.new({'customer_id' => customer5.customer_id, 'film_id' => film1.film_id})
ticket3 = Ticket.new({'customer_id' => customer2.customer_id, 'film_id' => film1.film_id})
ticket4 = Ticket.new({'customer_id' => customer1.customer_id, 'film_id' => film1.film_id})
